...
#import "SLRRTCPeerConnectionFactoryBuilder.h"
...
@implementation SLRRTCPeerConnectionFactoryBuilder {
...
+ (SLRRTCPeerConnectionFactoryBuilder *)builder {
  return [[SLRRTCPeerConnectionFactoryBuilder alloc] init];
}

- (SLRRTCPeerConnectionFactory *)createPeerConnectionFactory {
  SLRRTCPeerConnectionFactory *factory = [SLRRTCPeerConnectionFactory alloc];
