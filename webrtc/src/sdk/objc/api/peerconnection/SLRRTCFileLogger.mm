...
@implementation SLRRTCFileLogger {
  BOOL _hasStarted;
  NSString *_dirPath;
...
- (instancetype)initWithDirPath:(NSString *)dirPath
  ...
  return [self initWithDirPath:dirPath
                  ...
                  rotationType:SLRRTCFileLoggerTypeCall];
}

- (instancetype)initWithDirPath:(NSString *)dirPath
                    maxFileSize:(NSUInteger)maxFileSize
                   rotationType:(SLRRTCFileLoggerRotationType)rotationType {
  ...
  if (self = [super init]) {
    ...
    _severity = SLRRTCFileLoggerSeverityInfo;
  }
  return self;
}
...
- (rtc::LoggingSeverity)rtcSeverity {
  switch (_severity) {
    case SLRRTCFileLoggerSeverityVerbose:
      return rtc::LS_VERBOSE;
    case SLRRTCFileLoggerSeverityInfo:
      return rtc::LS_INFO;
    case SLRRTCFileLoggerSeverityWarning:
      return rtc::LS_WARNING;
    case SLRRTCFileLoggerSeverityError:
      return rtc::LS_ERROR;
  }
}
