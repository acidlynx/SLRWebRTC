...
@implementation SLRRTCCertificate
...
+ (nullable SLRRTCCertificate *)generateCertificateWithParams:(NSDictionary *)params {
  ...
  // grab PEMs and create an NS SLRRTCCerticicate
  ...
  SLRRTCCertificate *cert = [[SLRRTCCertificate alloc] initWithPrivateKey:@(pem_private_key.c_str())
