...
@class SLRRTCStatistics;

NS_ASSUME_NONNULL_BEGIN

/** A statistics report. Encapsulates a number of SLRRTCStatistics objects. */
@interface SLRRTCStatisticsReport : NSObject
...
/** SLRRTCStatistics objects by id. */
@property(nonatomic, readonly) NSDictionary<NSString *, SLRRTCStatistics *> *statistics;
...
@interface SLRRTCStatistics : NSObject

/** The id of this subreport, e.g. "SLRRTCMediaStreamTrack_receiver_2". */
