...
@implementation SLRRTCIceServer
...
- (instancetype)initWithURLStrings:(NSArray<NSString *> *)urlStrings
                          username:(NSString *)username
                        credential:(NSString *)credential
                     tlsCertPolicy:(SLRRTCTlsCertPolicy)tlsCertPolicy {
  return [self initWithURLStrings:urlStrings
                         username:username
                       credential:credential
...
- (NSString *)description {
  return [NSString stringWithFormat:@"SLRRTCIceServer:\n%@\n%@\n%@\n%@\n%@\n%@\n%@",
                                    _urlStrings,
                                    _username,
                                    _credential,
...
- (NSString *)stringForTlsCertPolicy:(SLRRTCTlsCertPolicy)tlsCertPolicy {
  switch (tlsCertPolicy) {
    case SLRRTCTlsCertPolicySecure:
      return @"SLRRTCTlsCertPolicySecure";
    case SLRRTCTlsCertPolicyInsecureNoCheck:
      return @"SLRRTCTlsCertPolicyInsecureNoCheck";
  }
}
...
- (instancetype)initWithNativeServer:
  ...
  SLRRTCTlsCertPolicy tlsCertPolicy;
  ...
  switch (nativeServer.tls_cert_policy) {
    ...
    case webrtc::PeerConnectionInterface::kTlsCertPolicyInsecureNoCheck:
      tlsCertPolicy = SLRRTCTlsCertPolicyInsecureNoCheck;
      break;
  }
