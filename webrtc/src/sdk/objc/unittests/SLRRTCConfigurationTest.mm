...
@interface SLRRTCConfigurationTest : NSObject
- (void)testConversionToNativeConfiguration;
- (void)testNativeConversionToConfiguration;
@end

@implementation SLRRTCConfigurationTest

- (void)testConversionToNativeConfiguration {
  NSArray *urlStrings = @[ @"stun:stun1.example.net" ];
  SLRRTCIceServer *server = [[SLRRTCIceServer alloc] initWithURLStrings:urlStrings];
  SLRRTCIntervalRange *range = [[SLRRTCIntervalRange alloc] initWithMin:0 max:100];
...
- (void)testNativeConversionToConfiguration {
  ...
  SLRRTCConfiguration *newConfig = [[SLRRTCConfiguration alloc]
...
TEST(SLRRTCConfigurationTest, NativeConfigurationConversionTest) {
  @autoreleasepool {
    SLRRTCConfigurationTest *test = [[SLRRTCConfigurationTest alloc] init];
