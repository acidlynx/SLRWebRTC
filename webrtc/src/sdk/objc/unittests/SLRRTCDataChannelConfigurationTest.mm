...
#import "api/peerconnection/SLRRTCDataChannelConfiguration+Private.h"
#import "api/peerconnection/SLRRTCDataChannelConfiguration.h"
#import "helpers/NSString+StdString.h"

@interface SLRRTCDataChannelConfigurationTest : NSObject
- (void)testConversionToNativeDataChannelInit;
@end

@implementation SLRRTCDataChannelConfigurationTest
...
- (void)testConversionToNativeDataChannelInit {
  ...
  SLRRTCDataChannelConfiguration *dataChannelConfig =
      [[SLRRTCDataChannelConfiguration alloc] init];
...
TEST(SLRRTCDataChannelConfiguration, NativeDataChannelInitConversionTest) {
  @autoreleasepool {
    SLRRTCDataChannelConfigurationTest *test =
        [[SLRRTCDataChannelConfigurationTest alloc] init];
