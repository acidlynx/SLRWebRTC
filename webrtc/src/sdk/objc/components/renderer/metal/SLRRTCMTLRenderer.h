...
/**
 * Protocol defining ability to render SLRRTCVideoFrame in Metal enabled views.
 */
@protocol SLRRTCMTLRenderer <NSObject>
...
/**
 * Implementation of SLRRTCMTLRenderer protocol.
 */
NS_AVAILABLE(10_11, 9_0)
@interface SLRRTCMTLRenderer : NSObject <SLRRTCMTLRenderer>

/** @abstract   A wrapped SLRRTCVideoRotation, or nil.
