...
#import "SLRRTCCVPixelBuffer.h"

#import "api/video_frame_buffer/SLRRTCNativeMutableI420Buffer.h"
...
@implementation SLRRTCCVPixelBuffer {
  int _width;
  int _height;
  int _bufferWidth;
  int _bufferHeight;
...
- (id<SLRRTCI420Buffer>)toI420 {
  ...
  SLRRTCMutableI420Buffer* i420Buffer =
      [[SLRRTCMutableI420Buffer alloc] initWithWidth:[self width] height:[self height]];
