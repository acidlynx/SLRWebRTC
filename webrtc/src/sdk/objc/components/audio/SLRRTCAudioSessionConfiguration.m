...
static SLRRTCAudioSessionConfiguration *gWebRTCConfiguration = nil;

@implementation SLRRTCAudioSessionConfiguration
...
- (instancetype)init {
  if (self = [super init]) {
    ...
    // core.
    if (processorCount > 1 && [UIDevice deviceType] != SLRRTCDeviceTypeIPhone4S) {
...
+ (instancetype)currentConfiguration {
  ...
  SLRRTCAudioSessionConfiguration *config =
      [[SLRRTCAudioSessionConfiguration alloc] init];
...
+ (instancetype)webRTCConfiguration {
  @synchronized(self) {
    return (SLRRTCAudioSessionConfiguration *)gWebRTCConfiguration;
  }
}

+ (void)setWebRTCConfiguration:(SLRRTCAudioSessionConfiguration *)configuration {
  @synchronized(self) {
