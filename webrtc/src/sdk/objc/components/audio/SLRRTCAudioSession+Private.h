...
@class SLRRTCAudioSessionConfiguration;

@interface SLRRTCAudioSession ()
...
/** Signals SLRRTCAudioSession that a WebRTC session is about to begin and
...
/** Signals SLRRTCAudioSession that a WebRTC session is about to end and audio
...
@property(nonatomic, readonly) std::vector<__weak id<SLRRTCAudioSessionDelegate> > delegates;
