...
class ObjCVideoDecoderFactory : public VideoDecoderFactory {
 public:
  explicit ObjCVideoDecoderFactory(id<SLRRTCVideoDecoderFactory>);
  ~ObjCVideoDecoderFactory() override;

  id<SLRRTCVideoDecoderFactory> wrapped_decoder_factory() const;
 ...
 private:
  id<SLRRTCVideoDecoderFactory> decoder_factory_;
};
