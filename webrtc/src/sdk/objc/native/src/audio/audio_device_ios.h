...
#include "sdk/objc/base/SLRRTCMacros.h"
#include "voice_processing_audio_unit.h"

RTC_FWD_DECL_OBJC_CLASS(SLRRTCNativeAudioSessionDelegateAdapter);
...
class AudioDeviceIOS : public AudioDeviceGeneric,
 ...
 private:
  ...
  SLRRTCNativeAudioSessionDelegateAdapter* audio_session_observer_
