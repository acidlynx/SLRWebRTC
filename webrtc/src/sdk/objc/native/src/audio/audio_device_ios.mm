...
#import "components/audio/SLRRTCNativeAudioSessionDelegateAdapter.h"
...
AudioDeviceIOS::AudioDeviceIOS()
  ...
  audio_session_observer_ = [[SLRRTCNativeAudioSessionDelegateAdapter alloc] initWithObserver:this];
}
