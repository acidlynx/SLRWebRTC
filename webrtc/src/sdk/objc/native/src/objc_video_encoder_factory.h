...
class ObjCVideoEncoderFactory : public VideoEncoderFactory {
 public:
  explicit ObjCVideoEncoderFactory(id<SLRRTCVideoEncoderFactory>);
  ~ObjCVideoEncoderFactory() override;

  id<SLRRTCVideoEncoderFactory> wrapped_encoder_factory() const;
 ...
 private:
  id<SLRRTCVideoEncoderFactory> encoder_factory_;
};
