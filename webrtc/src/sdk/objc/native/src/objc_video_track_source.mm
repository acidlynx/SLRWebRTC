...
@interface SLRRTCObjCVideoSourceAdapter ()
@property(nonatomic) webrtc::ObjCVideoTrackSource *objCVideoTrackSource;
@end

@implementation SLRRTCObjCVideoSourceAdapter
...
ObjCVideoTrackSource::ObjCVideoTrackSource(SLRRTCObjCVideoSourceAdapter *adapter) : adapter_(adapter) {
...
void ObjCVideoTrackSource::OnCapturedFrame(SLRRTCVideoFrame *frame) {
  ...
  } else if ([frame.buffer isKindOfClass:[SLRRTCCVPixelBuffer class]]) {
    // Adapted CVPixelBuffer frame.
    SLRRTCCVPixelBuffer *rtcPixelBuffer = (SLRRTCCVPixelBuffer *)frame.buffer;
    buffer = new rtc::RefCountedObject<ObjCFrameBuffer>([[SLRRTCCVPixelBuffer alloc]
