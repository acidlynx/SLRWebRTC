...
#import "base/SLRRTCVideoCapturer.h"

#include "base/SLRRTCMacros.h"
#include "media/base/adapted_video_track_source.h"
#include "rtc_base/timestamp_aligner.h"

RTC_FWD_DECL_OBJC_CLASS(SLRRTCVideoFrame);

@interface SLRRTCObjCVideoSourceAdapter : NSObject<SLRRTCVideoCapturerDelegate>
@end
...
class ObjCVideoTrackSource : public rtc::AdaptedVideoTrackSource {
 public:
  ...
  explicit ObjCVideoTrackSource(SLRRTCObjCVideoSourceAdapter* adapter);
  ...
  void OnCapturedFrame(SLRRTCVideoFrame* frame);

  // Called by SLRRTCVideoSource.
 ...
 private:
  ...
  SLRRTCObjCVideoSourceAdapter* adapter_;
};
