...
TEST_F(RtcpReceiverTest, InjectRrPacket) {
  ...
  std::vector<SLRRTCPReportBlock> report_blocks;
...
TEST_F(RtcpReceiverTest, InjectRrPacketWithReportBlockNotToUsIgnored) {
  ...
  std::vector<SLRRTCPReportBlock> received_blocks;
...
TEST_F(RtcpReceiverTest, InjectRrPacketWithTwoReportBlocks) {
  ...
  EXPECT_THAT(received_blocks,
              UnorderedElementsAre(Field(&SLRRTCPReportBlock::fraction_lost, 0),
                                   Field(&SLRRTCPReportBlock::fraction_lost, 10)));
  ...
  EXPECT_THAT(
      ...
      UnorderedElementsAre(
          AllOf(Field(&SLRRTCPReportBlock::source_ssrc, kReceiverMainSsrc),
                Field(&SLRRTCPReportBlock::fraction_lost, kFracLost[0]),
                Field(&SLRRTCPReportBlock::packets_lost, kCumLost[0]),
                Field(&SLRRTCPReportBlock::extended_highest_sequence_number,
                      kSequenceNumbers[0])),
          AllOf(Field(&SLRRTCPReportBlock::source_ssrc, kReceiverExtraSsrc),
                Field(&SLRRTCPReportBlock::fraction_lost, kFracLost[1]),
                Field(&SLRRTCPReportBlock::packets_lost, kCumLost[1]),
                Field(&SLRRTCPReportBlock::extended_highest_sequence_number,
                      kSequenceNumbers[1]))));
}
...
TEST_F(RtcpReceiverTest, InjectRrPacketsFromTwoRemoteSsrcs) {
  ...
  EXPECT_THAT(
      ...
      UnorderedElementsAre(
          AllOf(Field(&SLRRTCPReportBlock::source_ssrc, kReceiverMainSsrc),
                Field(&SLRRTCPReportBlock::sender_ssrc, kSenderSsrc),
                Field(&SLRRTCPReportBlock::fraction_lost, kFracLost[0]),
                Field(&SLRRTCPReportBlock::packets_lost, kCumLost[0]),
                Field(&SLRRTCPReportBlock::extended_highest_sequence_number,
                      kSequenceNumbers[0])),
          AllOf(Field(&SLRRTCPReportBlock::source_ssrc, kReceiverMainSsrc),
                Field(&SLRRTCPReportBlock::sender_ssrc, kSenderSsrc2),
                Field(&SLRRTCPReportBlock::fraction_lost, kFracLost[1]),
                Field(&SLRRTCPReportBlock::packets_lost, kCumLost[1]),
                Field(&SLRRTCPReportBlock::extended_highest_sequence_number,
                      kSequenceNumbers[1]))));
